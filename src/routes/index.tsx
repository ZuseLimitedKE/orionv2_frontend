            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  <Link
                    to="/login"
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold text-gray-900 hover:bg-[#1fbf75]/10"
                  >
                    Log in
                  </Link>
                </div>
        ...
        <div className="mx-auto max-w-2xl py-28 sm:py-44 lg:py-52">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-lg font-medium text-gray-500 sm:text-xl">
              Orion lets you invest in the stock market directly from your phone
              using mobile money. Build your portfolio, track real-time
              performance, and grow your wealth,all in one place!
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                to="/sign-up"
                className="rounded-md bg-[#1fbf75] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#18a763] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1fbf75]"
              >
                Get started
              </Link>
              <a
